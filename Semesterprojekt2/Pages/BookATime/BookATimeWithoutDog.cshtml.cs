...
{
    public class BookATimeWithoutDogModel : PageModel
    {
        ...
        public BookATimeWithoutDogModel(IBookATimeService bookATimeService, IUserService userService, YdelseService ydelseService, IWebHostEnvironment webHostEnvironment, DogService dogService)
        {
